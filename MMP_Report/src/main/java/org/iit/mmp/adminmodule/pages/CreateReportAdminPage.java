...
public class CreateReportAdminPage {
	...
	public void searchRecord(String searchName, String searchSSN) throws Exception {

		
		WebDriverWait  wait = new WebDriverWait(driver, 20);
		//String resultRecord = "//div[@id='show']//table//tbody//tr";
	...
	public void patientDetails(String ssn) throws Exception {
